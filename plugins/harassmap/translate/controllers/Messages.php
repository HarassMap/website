...
class Messages extends Controller
{
    ...
    {
        parent::__construct();
        BackendMenu::setContext('Harassmap.Translate', 'harassmap.translate');

        $this->addJs('/plugins/harassmap/translate/assets/js/messages.js');
        $this->addCss('/plugins/harassmap/translate/assets/css/messages.css');
    }
