    ...
    protected function createCsv($collection)
    {
        ...
        foreach ($collection as $item) {
            ...
            $writer->insertOne([
                ...
                'date' => $item->date,
                'address' => $item->location->address ? $item->location->address : 'nil',
                'city' => $item->location->city ? $item->location->city : 'nil',
                'position' => $item->location->lat ? $item->location->lat . ',' . $item->location->lng : 'nil',
                'role' => $item->role->name,
